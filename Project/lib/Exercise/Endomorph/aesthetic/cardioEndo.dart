...
class CardioEndo extends StatelessWidget{
      ...
      children: [
        ...
        ElevatedButton(
          ...
          child: const ListTile(
            ...
            title: Text('Crunches', textScaleFactor: 1.2, style: TextStyle(color: Colors. black)),
             ),
              onPressed: (){
        ...
        ElevatedButton(
          ...
          child: const ListTile(
            ...
            title: Text('Leg Raises', textScaleFactor: 1.2, style: TextStyle(color: Colors. black),),
             ),
              onPressed: (){
              
               Navigator.pushNamed(context, MyRoutes.legRaises);
              }
        ),
