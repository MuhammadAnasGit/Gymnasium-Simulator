...
class LowerBodyEndo1 extends StatelessWidget{
      ...
      children: [
        ...
        ElevatedButton(
          ...
          child: const ListTile(
            ...
            title: Text('Squats', textScaleFactor: 1.2, style: TextStyle(color: Colors. black),),
             ),
              onPressed: (){
               Navigator.pushNamed(context, MyRoutes.squat);
              }
        ),
          ...
          child: const ListTile(
            ...
            title: Text('Leg press', textScaleFactor: 1.2, style: TextStyle(color: Colors. black)),
              ...
              onPressed: (){
               ...
               Navigator.pushNamed(context, MyRoutes.legPress);
